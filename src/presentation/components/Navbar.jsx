          ...
          <Navbar.Collapse id="mainNavbar" className="w-100">
            ...
            <Nav className="ms-md-auto mt-3 mt-md-0">
              <NavDropdown
                ...
                align="end"
              >
                <NavDropdown.Item className="nav-item-dropdown-item" as={Link} to="/perfil/user-info" onClick={() => setExpanded(false)}>
                  Información de la cuenta
                </NavDropdown.Item>
                <NavDropdown.Item className="nav-item-dropdown-item" as={Link} to="/perfil/security" onClick={() => setExpanded(false)}>
                  Sesión y seguridad
                </NavDropdown.Item>
                <NavDropdown.Item 
